			...
			"/tags": map[string]any{
				"get": map[string]any{
					...
					"parameters": []map[string]any{
						...
						queryParam("show_zero", "Include zero-usage non-alias tags ('1' to opt in). Default hides them so the listing reflects what is actually applied to images, which is why the API total can be lower than the /tags page total."),
